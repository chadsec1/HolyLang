...
mod continue_stmt_in_global_tests {
    ...
    #[test]
    fn in_if_with_else_stmt_errors() {
        let literals = get_all_literals_edge_cases();
    ...
    #[test]
    fn in_if_with_elif_stmt_errors() {
        let literals = get_all_literals_edge_cases();
    ...
    #[test]
    fn in_if_else_with_elif_stmt_errors() {
        let literals = get_all_literals_edge_cases();
    ...
    #[test]
    fn in_if_with_else_with_elif_stmt_errors() {
        let literals = get_all_literals_edge_cases();
